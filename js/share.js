...
(function($, window, document, undefined) {
    ...
    function init(target, options) {
		...
		//初始化各个组件
        var $msb_main = "<a class='msb_main'><img title='分享' src='../img/sharecoresquare.png'></a>";
	...
	var douban = 'http://www.douban.com/share/service?href={url}&name={title}&text={content}&img={pic}';
